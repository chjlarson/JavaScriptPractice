...
function reportPark(p) {
    ...
    // Average Size
    ages = p.map(el => new Date().getFullYear() - el.buildYear)
...
function reportStreet(s) {
    ...
    conslole.log('Our ${s.length} streets have a total length of ${totalLength} km, with an average of ${avgLength} km.');
